...
const TRANSLATIONS = {
  en: {
    ...
    'case-vstz':        'VSTZ',
    'case-sogran':      'Sogran',
    'case-private-bank':'Private Bank Otkritie',
    'about-label':      'About',
  ...
  ru: {
    ...
    'hero-title-1':     'Прошлое создает',
    'hero-title-2':     'Будущее',
    'hero-tag-1':       'Думай',
    'hero-tag-2':       'Анализируй',
    'hero-tag-3':       'Создавай',
    'works-label':      'Работы, созданные с любовью, от настоящего к прошлому',
    'badge-identity':   'Айдентика',
    'badge-app-design': 'Апп дизайн',
    'badge-web-design': 'Веб-дизайн',
    'case-fantons':     'Фантон',
    'case-kalinka':     'ЛК партнера Калинка',
    'case-rgs':         'РГС онлайн',
    'case-bcoin':       'Бкоин 2048',
    'case-rusagroprom': 'Русагропром',
    'case-vstz':        'ВСТЗ',
    'case-sogran':      'Согран',
    'case-private-bank':'Прайват банк Открытие',
    'about-label':      'Обо мне',
    'about-bio':        'Сергей Голосов — арт-директор и дизайнер с <em>10-летним опытом</em> в продуктовом, веб и бренд дизайне. Я создаю <em>дизайн продуктов для финтеха, страхования, сложных B2B/B2E интерфейсов</em>. Я верю, что хороший дизайн исчезает — и остаётся лишь человек, который получил нужное без лишних усилий',
    'footer-cta':       'Связаться',
    'footer-link-linkedin': 'Линкедин',
